...
function App(props) {
  ...
  */
  ...
  const StarProviderEvents = useEventListener(readContracts, "DEX", "StarProvider", localProvider, 1);
  
  // console.log("We have a new star ", StarProviderEvents);
  // 
